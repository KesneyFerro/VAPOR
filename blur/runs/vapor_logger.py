"""
VAPOR Comprehensive Logging System

This module provides a comprehensive logging system for tracking all experiments,
runs, and processing operations in VAPOR. It ensures complete reproducibility
...
class VaporLogger:
    """
    Comprehensive logging system for VAPOR experiments.
    ...
    def __init__(self, run_type: str, base_dir: Path = None, run_id: str = None):
        ...
        self.logger.info(f"Initialized VAPOR logger for {run_type} run: {self.run_id}")
    ...
    def _setup_logging(self):
        ...
        self.logger = logging.getLogger(f'vapor_{self.run_id}')
...
def create_logger(run_type: str, base_dir: Path = None) -> VaporLogger:
    """
    Create a VAPOR logger instance.
    ...
    Returns:
        Configured VaporLogger instance
    """
    return VaporLogger(run_type, base_dir)
